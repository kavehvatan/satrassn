...
export default function Page() {
  ...
  return (<div style={{minHeight:'100vh', background:'#f5f5f5', padding:'24px'}}><main style={{maxWidth:1100, margin:'0 auto', padding:24, fontFamily:'system-ui, -apple-system, Segoe UI, Roboto'}}>
