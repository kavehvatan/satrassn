...
const box: React.CSSProperties = { maxWidth: 1200, margin: "32px auto", padding: 24, border: "1px solid #eee", borderRadius: 16, background: "#fff", background: '#fff', padding: 24, border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.06)'};
...
export default function UnityXtRaidCalculator() {
  ...
  return (<div style={{minHeight:'100vh', background:'#f5f5f5', padding:'24px'}}><main style={{ padding: 16, background: "#F3F4F6", minHeight: "100vh" }}>
      <div style={box}>
