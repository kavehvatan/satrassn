...
export default function UnityCalculatorPage() {
  ...
  const box: React.CSSProperties = { maxWidth: 720, margin: "32px auto", padding: 24, border: "1px solid #eee", borderRadius: 12, fontFamily: "ui-sans-serif, system-ui", background: '#fff', padding: 24, border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.06)'};
  ...
  return (<div style={{minHeight:'100vh', background:'#f5f5f5', padding:'24px'}}><main style={box}>
